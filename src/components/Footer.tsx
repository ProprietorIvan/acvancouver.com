        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Your trusted partner for professional painting and drywall
              services across Vancouver & Burnaby. Our expert team delivers
              premium finishes and reliable repairs with exceptional attention
              to detail, using professional tools and premium materials for
              flawless results.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li className="hover:text-white transition-colors duration-300">
                <Link href="/drywall-services">Drywall Services</Link>
              </li>
              <li className="hover:text-white transition-colors duration-300">
          ...
          <div>
            ...
            <div className="text-gray-300 space-y-4">
              <div>
                <p className="font-semibold mb-2">Service Hours:</p>
              ...
              <div className="pt-4 border-t border-gray-700">
                ...
                <a
                  href="mailto:info@acvancouver.com"
                  className="flex items-center gap-2 hover:text-white transition-colors duration-300 cursor-pointer mb-3"
                >
                  <Mail size={16} />
                  <p>info@acvancouver.com</p>
                </a>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
            <div className="text-center md:text-left mb-4 md:mb-0">
              <p>
                © {new Date().getFullYear()} WallPro Repairs & Finishing. ALL
                RIGHTS RESERVED
              </p>
            </div>
